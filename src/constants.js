...
import CHatLOgo from './assets/work_logo/ChatGPT.png';
...
export const projects = [
...

  {
    ...
    title: "OpenAI Clone",
    description:
      "A fully functional ChatGpt clone build using MERN stack and OpenRouter Api with all tasks of chatgpt.",
    image: CHatLOgo,
    tags: ["HTML", "CSS", "JavaScript","React","node.js","MongoDB","Express","OpenRouterAPI"],
    github: "https://github.com/Subrat-IO/My_APp",
    webapp: "https://my-a-pp-theta.vercel.app/",
  },
